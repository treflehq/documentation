...
| **growth_rate** (string)                      |                                                                                                                                                                                                                    |
| **edible_part** (string)                      | The edible part of the species (if any). Several values can be separated by "\|"  <br />Can be: `roots`, `stem`, `leaves`, `flowers`, `fruits`, `seeds`, and `tubers`.                                                       |
| **vegetable** (boolean)                       |                                                                                                                                                                                                                    |
